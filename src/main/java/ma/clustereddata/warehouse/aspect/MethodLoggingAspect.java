package ma.clustereddata.warehouse.aspect;
...
public class MethodLoggingAspect {
    ...
    @Before("execution(* ma.clustereddata.warehouse.services.implementation.*.*(..))")
    ...
    @AfterThrowing(pointcut = "execution(* ma.clustereddata.warehouse.services.implementation.*.*(..))", throwing = "exception")
    ...
    @AfterReturning(pointcut = "execution(* ma.clustereddata.warehouse.services.implementation.*.*(..))", returning = "result")
